...
const authvalidation_1 = require("../Auth/authvalidation");
...
router.post('/login', (0, validateRequest_1.default)(authvalidation_1.AuthValidation.loginZodSchema), auth_controller_1.authController.loginAdmin);
